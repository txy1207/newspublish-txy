...
import { Button, PageHeader,Steps,Form,Input,message,notification,Select } from 'antd'
...
<div className={current===1?'':style.active}>222
...
<div className={current===3?'':style.active}>3333</div>
